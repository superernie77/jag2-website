...
const SERVICE_TILES = [
  { num: '01', title: 'Java Development', body: 'Robust, maintainable Java solutions tailored to your stack.' },
  { num: '02', title: 'Software Architecture', body: 'Design and review of scalable, future-proof systems.' },
